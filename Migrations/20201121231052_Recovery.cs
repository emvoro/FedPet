    ...
    public partial class Recovery : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Pet_Id = table.Column<int>(type: "int", nullable: false),
                    FirstFeeding = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SecondFeeding = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ThirdFeeding = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Schedule", x => x.Pet_Id);
                    table.ForeignKey(
